...
namespace ConnFromConfig
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string connectionString = ConfigurationManager.ConnectionStrings["AdventureWorksTrusted"].ConnectionString;
            ...
            Console.WriteLine("Connection til lokal (VS)-database");
           connectionString = ConfigurationManager.ConnectionStrings["localKRM"].ConnectionString;
...
//                conn.Open();
                ...
                while (Results.Read())
                {
                    Console.WriteLine(Results.GetInt32(0) + " " + Results.GetString(1) + " " + Results.GetDateTime(5));
                }
            }
        }
    }
